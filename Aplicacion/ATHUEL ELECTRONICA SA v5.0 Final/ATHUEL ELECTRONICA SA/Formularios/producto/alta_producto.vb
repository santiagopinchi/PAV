Public Class alta_producto
    ...
    Private Sub transferir_datos_producto()
        ...
        Me._producto.codProducto = Integer.Parse(Me.txt_cod_producto.Text)
    ...
    Private Sub btn_agregar_Click(sender As Object, e As EventArgs) Handles btn_agregar.Click
        ...
        If validacion() = True Then
            If _BD.leo_tabla("SELECT * FROM producto WHERE codTipoProd = '" & _producto.codigoTipoprod & "' AND codProd =" & _producto.codProducto).Rows.Count = 0 Then
                Me._producto.insertar()
                MsgBox("Se grabó con éxito el producto")
                blanquear()
            Else
                MsgBox("Producto ya existente", MsgBoxStyle.Critical, "Error")
            End If
        End If
    End Sub
