Public Class proveedores
    ...
    End Sub
    Public Sub modificar(ByVal cuit As Integer)
        Dim sql As String = ""
        ...
        Me._BD.INS_MOD_BOR(sql)
    End Sub
    Public Sub borrar(ByVal cuit As Integer)
        Dim sql As String = ""
    ...
    Public Function validar() As String
        ...
        End If
        If Me._tipo_proveedor <> "E" Or Me._tipo_proveedor <> "N" Then
            Return "El tipo de proveedor debe ser N (nacional) o E (extranjero)"
        End If
        Return "CORRECTO"
    End Function


    Public Sub buscar_proveedor(ByVal cuit As Integer)
    ...
    Private Sub traferir(ByVal tabla As DataTable)
        ...
        _fecha_inicio = tabla.Rows(0)("formateada").text
